...
//       'pJ1RYscoqu8fTy3BrKKw1rVm2AbHlKEpMNBHMqxOpzx+yBiaw/R+Tg=='; // AccessKey obtained from Picovoice Console (https://console.picovoice.ai/)
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: const Color.fromARGB(255, 9, 1, 22)),
        useMaterial3: true,
      ),
      home: const HomePage(),
    );
